...
┗─•${global.botname}•─⬣[⿻
[[ ༑📚Cʀᴇᴀᴛᴇᴅ ʙʏ Rɪᴅᴢ Cᴏᴅᴇʀ༢⿻ ༑]]`
})


			

            console.log('>𝑹𝑰𝑫𝒁 𝑴𝑪𝑫 Bot is Connected< [ ! ]')
		}
...
trashcore.ev.on('group-participants.update', async (anu) => {
    ...
    trashcore.ev.on('messages.upsert', async chatUpdate => {
        ...
        try {
            ...
            require("./ridzhandler")(trashcore, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
...
function cleanupOldMessages() {
    ...
    console.log("[𝑹𝑰𝑫𝒁 𝑴𝑪𝑫] 🧹 Cleaning up:");
