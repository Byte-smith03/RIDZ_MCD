...
module.exports.welcome = async (iswel, isleft, trashcore, anu) => {
  try {
    ...
    try {
      ...
      ppgroup = 'https://i.ibb.co/Ng1j73Yy/20250810-192007.png'
    }
      ...
      await trashcore.sendMessage(anu.id, {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            ...
            body: `${global.botname}`,
            thumbnailUrl: ppgroup,
            sourceUrl: "//whatsapp.com/channel/0029VbB5hQD9mrGjnplDZp2l",
            mediaType: 1,
            renderLargerThumbnail: true
          }
        }
      ...
      await trashcore.sendMessage(anu.id, {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            ...
            body: `${global.botname}`,
            thumbnailUrl: ppgroup,
            sourceUrl: "https://whatsapp.com/channel/0029VbB5hQD9mrGjnplDZp2l",
            mediaType: 1,
            renderLargerThumbnail: true
          }
        }
